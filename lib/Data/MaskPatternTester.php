...
class MaskPatternTester{
	...
	/**
	 * @var \RefPro\QRCode\Data\QRMatrix
	 */
	protected $matrix;
	 ...
	 *
	 * @see \RefPro\QRCode\QROptions::$maskPattern
	 * @see \RefPro\QRCode\Data\QRMatrix::$maskPattern
	 * @see \RefPro\QRCode\QRCode::getBestMaskPattern()
	 *
