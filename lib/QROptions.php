...
require_once __DIR__.'/SettingsContainerAbstract.php';

use RefPro\Settings\SettingsContainerAbstract;
...
class QROptions extends SettingsContainerAbstract{
	...
	public function __set($property, $value){
		...
		if(in_array($property, array('eccLevel', 'maskPattern', 'imageTransparencyBG', 'version'), true)){
	 ...
	 * @return void
	 */
	protected function setMinMaxVersion($versionMin, $versionMax){
	 ...
	 */
	protected function set_eccLevel($eccLevel){
	 ...
	 * @return void
	 */
	protected function set_maskPattern($maskPattern){
	 ...
	 * @throws \RefPro\QRCode\QRCodeException
	 */
	protected function set_imageTransparencyBG($imageTransparencyBG){

		// invalid value - set to white as default
		if(!is_array($imageTransparencyBG) || count($imageTransparencyBG) < 3){
			$this->imageTransparencyBG = array(255, 255, 255);
